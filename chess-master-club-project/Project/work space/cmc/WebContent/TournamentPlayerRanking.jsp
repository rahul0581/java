...
function gettor(tid,objID)
{
	...
	var s="getResultTornamentPlayerID.jsp?tid="+tid;
	ajax(s,objID);
}
...
<table >
<tr><td></td> </tr>
<tr><td>Tournament Player ID :</td><td><input type="text" id="tid" name="tid" onblur="gettor(document.getElementById('tid').value,'result');"></td></tr>
