...
<!-- Add jQuery library -->
<script type="text/javascript" src="lib/jquery-1.9.0.min.js">
</script>
...
<script type="text/javascript" src="source/jquery.fancybox.js?v=2.1.4">
</script>
...
<script type="text/javascript"
	src="source/helpers/jquery.fancybox-thumbs.js?v=1.0.7">
</script>

<!-- Add Media helper (this is optional) -->
<script type="text/javascript"
	src="source/helpers/jquery.fancybox-media.js?v=1.0.5">
</script>
...
<div id="menu">
	...
	<ul>
			...
			<li><a href="ktt.html">Know the tips</a>
			</li>
...
<div id="logo">
	...
	<h1>Chess 
	 <p><a class="fancybox fancybox.ajax" href="chessGame/game.jsp">Playgame</a></p>
...
<div id="page">
	...
	<div id="content">
		...
		<iframe src="listVideos.html" seamless width="550px" height="550px" scrolling="no" frameborder="0" name="video">
</iframe> 
...
<div class="content">
				...
				<form id="searchform" method="get" action="Result.jsp" target="video">
...
<div id="footer">
	...
	<p id="legal">&copy;2016  Masters Club. <br />
		</p>
...
<abbr title="eXtensible HyperText Markup Language">XHTML</abbr></a> | <a href="http://jigsaw.w3.org/css-validator/check/referer" title="This page validates as CSS"><abbr title="Cascading Style Sheets">CSS</abbr></a></p>
</div>
</body>
</html>
