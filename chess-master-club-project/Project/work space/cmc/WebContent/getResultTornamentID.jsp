...
<body>
<form id="myForm" action="TournamentDeleteServlet" method="post">
<table >
<tr><td><div id="error"></div></td> </tr>
<tr><td>Tournament ID :</td><td><input type="text" id="tid" name="tid" disabled="disabled" value="<%=l.get(0).getTid()%>"></td></tr>
<tr><td>Tournament Name :</td><td><input type="text" name="tname" disabled="disabled" value="<%=l.get(0).getTname()%>"></td></tr>
<tr><td>Tournament Date :</td><td><input type="text" id="datepicker" name="date" disabled="disabled" value="<%=l.get(0).getDate()%>" /></td></tr>

<tr><td>Tournament Venu :</td><td><input type="text" name="venu" disabled="disabled" value="<%=l.get(0).getVenu()%>"></td></tr>

<tr><td></td><td><input type="submit" value="Delete Tournament"><br></td></tr>
</table>
